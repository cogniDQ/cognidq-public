...
the CogniDQ project a harassment-free experience for everyone, regardless
...
pull requests, discussions, code review, and any official social channel
...
be reported to the maintainers via a private channel. Use the contact
listed in [SECURITY.md](SECURITY.md) for confidential reports.
