...
USERS = [
    ...
    ("admin@example.com", "Platform Admin",        "change-me-strong-password",  "platform_admin", "8062ed84-5660-4470-833c-f748ed0a7481", "ACTIVE"),
    ("qa.wsadmin@example.com",    "QA Workspace Admin",    "change-me-strong-password",   None,             None, "ACTIVE"),
    ("qa.member@example.com",     "QA Workspace Member",   "change-me-strong-password",    None,             None, "ACTIVE"),
    ("qa.outsider@example.com",   "QA Other Tenant User",  "change-me-strong-password",  None,             None, "ACTIVE"),
